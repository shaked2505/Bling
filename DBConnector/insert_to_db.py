...
connector.execute_query(sql, values)
values=(2005, 520.0, str(date(2023, 3, 12)) , 'Approved', 1005, 80, None )
connector.execute_query(sql, values)
values=(2006, 300.0, str(date(2023, 4, 15)) , 'Approved', 1005, 80, 50 )
connector.execute_query(sql, values)
values=(2007, 260.0, str(date(2023, 4, 13)) , 'Approved', 1006, 4, None )
connector.execute_query(sql, values)
values=(2008, 80.0, str(date(2023, 4, 13)) , 'Approved', 1006, 4, 301 )
connector.execute_query(sql, values)
values=(2009, 70.0, str(date(2023, 4, 13)) , 'Approved', 1006, 4, 302 )
connector.execute_query(sql, values)
values=(2010, 70.0, str(date(2023, 5, 10)) , 'Approved', 1003, 100, 302 )
connector.execute_query(sql, values)
